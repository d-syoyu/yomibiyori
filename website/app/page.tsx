          ...
          <div className="page-container grid lg:grid-cols-2 gap-12 items-center relative z-10">
            <div className="space-y-8 text-center lg:text-left animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link href="https://apps.apple.com/us/app/%E3%82%88%E3%81%BF%E3%81%B3%E3%82%88%E3%82%8A/id6754638890" className="inline-flex items-center gap-3 bg-black text-white px-4 py-2 rounded-xl hover:bg-gray-800 transition-colors shadow-lg">
                  ...
                  <div className="flex flex-col items-start leading-none">
                    ...
                    <span className="text-xl font-bold -mt-1 font-sans">App Store</span>
                  </div>
                </Link>
