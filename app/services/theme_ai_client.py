...
class OpenAIThemeClient(ThemeAIClient):
    ...
    # カテゴリー別のプロンプト定義
    CATEGORY_PROMPTS = {
        "恋愛": "恋愛・片思い・ときめき・デート・出会い・別れなど、恋にまつわるシーンを斬新で心に残る表現で詠んでください。ありきたりな表現は避け、意外性のある視点で。",
        "季節": "春夏秋冬の季節感、天気、自然の移り変わりを、見慣れた風景に新しい発見をもたらす視点で表現してください。季語にとらわれず、現代的な感性で。",
        "日常": "日常生活、通勤・通学、食事、趣味などの身近な瞬間に潜む気づきや発見を、ユニークな切り口で表現してください。",
        "ユーモア": "日常のあるある、ちょっとした失敗、面白い発見などを、クスッと笑えるユーモアと新鮮な驚きで表現してください。時には皮肉やネットミーム的な要素も取り入れて、現代的な笑いを演出してください。",
    }
